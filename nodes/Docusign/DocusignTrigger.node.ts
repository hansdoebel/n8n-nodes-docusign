    ...
    properties: [
      {
        ...
        options: [
          ...
          },
          {
            ...
            description:
              "Sent when the envelope is corrected within the web application or via any of the Envelopes/EnvelopesRecipients API calls",
          },
          {
          ...
          },
          {
            ...
            description:
              "This event is sent after an already-sent envelope is deleted within the web application",
          },
          {
          ...
          },
          {
            ...
            description:
              "Sent when the envelope is queued to be purged within the web application or via the Update Envelopes API call",
          },
          {
            name: "envelope-resent",
            value: "envelope-resent",
            description:
              "Sent when the envelope is resent within the web application or via the Envelopes API call",
          },
          {
            name: "envelope-sent",
            value: "envelope-sent",
          ...
          },
          {
            ...
            description:
              "Sent when the recipient selects finish within the web application on an Envelope",
          },
          {
            name: "recipient-reassign",
            value: "recipient-reassign",
            description:
              "Sent when the envelope is reassigned by a recipient within the web application",
          },
          {
          ...
          },
          {
            ...
            description:
              "Sent when a Template is created within the web application or via the create Templates API call",
          },
          {
            name: "templated-deleted",
            value: "templated-deleted",
            description:
              "Sent when a Template is deleted within the web application or via the recycle bin API call",
          },
          {
            name: "templated-modified",
            value: "templated-modified",
            description:
              "Sent when a Template is modified within the web application or via the update Templates API call",
          },
        ],
        required: true,
        default: [],
